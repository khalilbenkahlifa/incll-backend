...
$sql1="select * from avs_salary_history where index_number='$index' and _status='$desc' and date='$date'";
...
$sql2="select * from avs_salary where index_number='$index' and _status='Advance' and month='$month'";
$result2=mysqli_query($conn,$sql2);
