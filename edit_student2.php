...
$sql1 = "SELECT * FROM Parent WHERE my_son_index=$std_index";
                        	...
                        	<div class="row">
                                    ...
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" >
                                                <div class="col-xs-5" id="divtéléphone">
                                                    <label for="exampleInputEmail1">téléphone</label>
                                                </div>
                                                <div class="col-xs-7" id="divtéléphone1">
                                                	<input type="text" class="form-control" id="téléphone" name="téléphone" data-inputmask='"mask": "(999) 999-9999"' data-mask value="<?php echo $row['téléphone']; ?>">
                                                </div> 
                                        	</div>  
                                            <div class="form-group" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            <div class="form-group" >
                                                <div class="col-xs-5" id="divGtéléphone">
                                                    <label for="exampleInputEmail1">téléphone</label>
                                                </div>
                                                <div class="col-xs-7" id="divGtéléphone1">
                                                	<input type="text" class="form-control" id="g_téléphone" name="g_téléphone" data-inputmask='"mask": "(999) 999-9999"' data-mask value="<?php echo $row1['téléphone']; ?>" >
                                                </div> 
                                        	</div>
                                            <div class="form-group" >
...
$("form").submit(function (e){
	...
	if(index_number == '' || g_index_number == '' || fname == '' || g_fname == '' || surname == '' || g_surname == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender == 'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) == false || g_email == '' || mailformat.test(g_email) == false || téléphone == ''  || g_téléphone == '' ) {
