...
?>                        
            				<div class="">
                            	...
                            	<a href="#" onClick="showFriends('<?php echo $my_type; ?>','Student','<?php echo $my_index; ?>')" class="btn btn-md bg-purple-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Student</i></a>
