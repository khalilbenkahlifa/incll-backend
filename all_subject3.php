...
$sql1="SELECT * FROM Parent WHERE index_number='$index'";
...
$sql="select subject_routing.id as sr_id,subject_routing.fee as s_fee,grade.name as g_name,subject.name as s_name,teacher.surname as t_name
