                			...
                			<div class=" col-md-9"> 
                  				<table class="table table-bordered table-striped">
                    				<tbody>
                                        ...
                                        <tr>
                        					<td>Password</td>
                        					<td id="téléphone"><?php echo $password; ?> </td>
                      					</tr>
                    				</tbody>
                  				</table>
                  			</div>
...
function editMyProfile(my_index){
	...
	var xhttp = new XMLHttpRequest();//MSK-000131-Start Ajax  
				...
				var xhttp1 = new XMLHttpRequest();//MSK-000131-Start Ajax  
					xhttp1.onreadystatechange = function() {		
						...
						if (this.readyState == 4 && this.status == 200) {
							...
							document.getElementById("fname1").value =myArray[1];//MSK-000114
							document.getElementById("surname1").value =myArray[2];//MSK-000114
							document.getElementById("gender2").value =myArray[3];//MSK-000114
							document.getElementById("address1").value =myArray[4];//MSK-000114
							document.getElementById("téléphone1").value =myArray[5];//MSK-000114
							document.getElementById("email1").value =myArray[6];//MSK-000114
							document.getElementById("profile_pic1").src ="../"+myArray[7];
							document.getElementById("password1").value =myArray[8];//MSK-000114
							...
							$("form").submit(function (e){
								...
								if(téléphone == ''){
									//MSK-00102-fname 
									$("#btnUpdate").attr("disabled", true);
									//$('#tdtéléphone1').addClass('has-error has-feedback');
					...
					xhttp1.open("GET", "../model/get_avs_profile.php?my_index=" + my_index , true);												
		...
		xhttp.open("GET", "my_profile_update_form4.php" , true);												
