...
<?php include_once('header_Parent.php'); ?>
...
$sql1="SELECT * FROM Parent WHERE index_number='$my_index'";
$result1=mysqli_query($conn,$sql1);
$row1=mysqli_fetch_assoc($result1);
if (isset($yourArray['my_son_index'])) {
    // The key 'my_son_index' exists in the array
    // You can safely access it here
    $mySonValue = $yourArray['my_son_index'];
} else {
    // The key 'my_son_index' does not exist in the array
    // Handle the error or set a default value if needed
    $mySonValue = 'default_value';
}
...
$my_son_index = ""; // Define the variable with a default value

// Check if the variable is set and not empty
if (isset($my_son_index)) {
    // The variable is defined and not empty, you can use it here
    // For example, you can echo its value or perform other operations
    echo $my_son_index;
} else {
...
$sql2="SELECT * FROM Parent WHERE index_number='$index'";
$result2=mysqli_query($conn,$sql2);
$row2=mysqli_fetch_assoc($result2);
...
$sql="select subject.name as s_name,teacher.surname as t_name,class_room.name as c_name
      from timetable
      inner join subject
